...
# Secreto compartido con el repo de máquinas para firmar/verificar FLAGS
FLAG_SECRET = config('FLAG_SECRET', default='insecure-default-change-me')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = config('DEBUG', default=False, cast=bool)

ALLOWED_HOSTS = ['securethebox.cat', 'www.securethebox.cat', 'localhost', '127.0.0.1']
...
# Solo activar estas si NO estamos en modo desarrollo
if not DEBUG:
    SECURE_SSL_REDIRECT = True
    SESSION_COOKIE_SECURE = True
    CSRF_COOKIE_SECURE = True
else:
    # En local, dejamos esto en False para poder entrar
